const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=3530103&appid=06b398ce5a9a3ebc9b95042ec888e67b&units=imperial"
const apiForecastURL = "https://api.openweathermap.org/data/2.5/forecast?id=3530103&appid=06b398ce5a9a3ebc9b95042ec888e67b&units=imperial"
...
fetch(apiURL)
    ...
    .then((jsObject) => {
        document.getElementById('message').textContent = jsObject.weather[0].main;
        document.getElementById('currentTemp').textContent = Math.round(jsObject.main.temp);
        document.getElementById('humidity').textContent = jsObject.main.humidity;
        document.getElementById('windSpeed').textContent = Math.round(jsObject.wind.speed);
        document.getElementById('chill').textContent = getWindChill();
